...
object Exceptions {
  ...
  def toException(code: String, message: String, usage: Option[Double]) =
    ...
    def makeException(code: String, message: String, boxUsage: Double) = code match {
      ...
      case "InvalidAction" => new InvalidAction(code, message, boxUsage)
      case "InvalidBatchRequest" => new InvalidBatchRequest(code, message, boxUsage)
      case "InvalidHTTPAuthHeader" => new InvalidHTTPAuthHeader(code, message, boxUsage)
      case "InvalidHttpRequest" => new InvalidHttpRequest(code, message, boxUsage)
      case "InvalidLiteral" => new InvalidLiteral(code, message, boxUsage)
      case "InvalidNextToken" => new InvalidNextToken(code, message, boxUsage)
      case "InvalidNumberPredicates" => new InvalidNumberPredicates(code, message, boxUsage)
      case "InvalidNumberValueTests" => new InvalidNumberValueTests(code, message, boxUsage)
      case "InvalidParameterCombination" => new InvalidParameterCombination(code, message, boxUsage)
      case "InvalidParameterValue" => new InvalidParameterValue(code, message, boxUsage)
      case "InvalidQueryExpression" => new InvalidQueryExpression(code, message, boxUsage)
      case "InvalidResponseGroups" => new InvalidResponseGroups(code, message, boxUsage)
      case "InvalidService" => new InvalidService(code, message, boxUsage)
      case "InvalidSOAPRequest" => new InvalidSOAPRequest(code, message, boxUsage)
      case "InvalidURI" => new InvalidURI(code, message, boxUsage)
      case "InvalidWSAddressingProperty" => new InvalidWSAddressingProperty(code, message, boxUsage)
      case "MalformedSOAPSignature" => new MalformedSOAPSignature(code, message, boxUsage)
      case "MissingAction" => new MissingAction(code, message, boxUsage)
      case "MissingParameter" => new MissingParameter(code, message, boxUsage)
      case "MissingWSAddressingProperty" => new MissingWSAddressingProperty(code, message, boxUsage)
      case "NoSuchDomain" => new NoSuchDomain(code, message, boxUsage)
      case "NoSuchVersion" => new NoSuchVersion(code, message, boxUsage)
      case "NotYetImplemented" => new NotYetImplemented(code, message, boxUsage)
      case "NumberDomainsExceeded" => new NumberDomainsExceeded(code, message, boxUsage)
      case "NumberDomainAttributesExceeded" => new NumberDomainAttributesExceeded(code, message, boxUsage)
      case "NumberDomainBytesExceeded" => new NumberDomainBytesExceeded(code, message, boxUsage)
      case "NumberItemAttributesExceeded" => new NumberItemAttributesExceeded(code, message, boxUsage)
      case "NumberSubmittedAttributesExceeded" => new NumberSubmittedAttributesExceeded(code, message, boxUsage)
      case "NumberSubmittedItemsExceeded" => new NumberSubmittedItemsExceeded(code, message, boxUsage)
      case "QueryTimeout" => new QueryTimeout(code, message, boxUsage)
      case "RequestExpired" => new RequestExpired(code, message, boxUsage)
      case "RequestTimeout" => new RequestTimeout(code, message, boxUsage)
      case "ServiceUnavailable" => new ServiceUnavailable(code, message, boxUsage)
      case "TooManyRequestedAttributes" => new TooManyRequestedAttributes(code, message, boxUsage)
